...
def get_flags():
    ...
    _SELF_INTERACTION_HELP = (
        "Type of self-interaction in {}. Values: '1x1' (simple) and 'att' (attentive). "
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="SE3TransformerIterative",
    ...
    parser.add_argument(
        "--num_iter", type=int, default=1, help="Number of SE3 Transformers stacked"
    )
    parser.add_argument(
    ...
    parser.add_argument("--forward", type=int, default=0, help="Run forward pass")
    parser.add_argument(
        "--gd_post_process",
        type=int,
        default=1,
